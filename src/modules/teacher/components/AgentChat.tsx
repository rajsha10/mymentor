    ...
    <div className="flex h-[600px] overflow-hidden">
      ...
      <div className="flex flex-col flex-1 min-w-0 border-r border-gray-200">
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200 bg-white shrink-0">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">Ask anything about the uploaded documents</p>
          </div>
        </div>
      ...
      <div className="w-64 shrink-0 flex flex-col bg-white overflow-y-auto">
        <div className="px-4 py-3 border-b border-gray-200 shrink-0">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Response Details</p>
        </div>
